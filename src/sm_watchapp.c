...
enum {CALENDAR_LAYER, NUM_LAYERS};
...
static void init(void) {
  ...
  window_stack_push(window, animated);
	...
	//battery_image_layer = bitmap_layer_create(GRect(12, 1, 20, 10));
	...
	//battery_pbl_image_layer = bitmap_layer_create(GRect(144-27, 1, 20, 10));
	...
	text_battery_layer = text_layer_create(GRect(35, -2, 40, 15));
	...
	battery_layer = layer_create(GRect(12, 1, 20, 10));
	...
	battery_pbl_layer = layer_create(GRect(144-27, 1, 20, 10));
	...
	//text_weather_cond_layer = text_layer_create(GRect(0, 168-47, 143, 40));
	text_weather_cond_layer = text_layer_create(GRect(2, 168-50, 144, 40));
	...
	//weather_image = bitmap_layer_create(GRect(144-43, 168-41, 40, 40)); 
	weather_image = bitmap_layer_create(GRect(-5, 168-44, 40, 40)); 
	...
	//text_weather_temp_layer = text_layer_create(GRect(144-55, 168-16, 70, 15)); 
	text_weather_temp_layer = text_layer_create(GRect(-5, 168-16, 40, 15)); 
	...
	layer_set_frame(text_layer_get_layer(text_date_layer), GRect(0, 90, 144, 168-90));
	...
	//init calendar layer
	animated_layer[CALENDAR_LAYER] = layer_create(GRect(0, 0, 144, 168));
	layer_add_child(window_layer, animated_layer[CALENDAR_LAYER]);
	
	calendar_date_layer = text_layer_create(GRect(30, 168-32, 144-32, 21));
	text_layer_set_text_alignment(calendar_date_layer, GTextAlignmentRight);
	...
	calendar_text_layer = text_layer_create(GRect(30, 168-17, 144-32, 28));
	text_layer_set_text_alignment(calendar_text_layer, GTextAlignmentRight);
